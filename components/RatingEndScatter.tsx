...
export default function ScatterChart({
	...
	const dateRatingDataSorted = dateRatingData.sort(
		(a, b) => new Date(a.endWatchDate!).getTime() - new Date(b.endWatchDate!).getTime()
	)
	...
	const lineRegFuncRating1 = linearRegressionLine(
		linearRegression(
			dateRatingData
				.map((item) => {
					return [new Date(item.endWatchDate!).getTime(), item.rating1average!]
				})
				.filter((item) => item[0])
		)
	)
	const lineRegFuncRating2 = linearRegressionLine(
		linearRegression(
			dateRatingData
				.map((item) => {
					return [new Date(item.endWatchDate!).getTime(), item.rating2average!]
				})
				.filter((item) => item[0])
		)
	)
	const lineRegFuncRatingMal = linearRegressionLine(
		linearRegression(
			dateRatingData
				.map((item) => {
					return [new Date(item.endWatchDate!).getTime(), item.malRating!]
				})
				.filter((item) => item[0])
		)
	)
					...
					},
					{
						...
						data: Array(14)
							...
							.map((i, index) => {
								...
								return {
									x: increment + 1_500_000_000_000,
									y: lineRegFuncRating1(increment + 1_500_000_000_000)
								}
							}),
						showLine: true,
						borderColor: '#8a293e',
					...
					},
					{
						...
						data: Array(14)
							...
							.map((i, index) => {
								...
								return {
									x: increment + 1_500_000_000_000,
									y: lineRegFuncRating2(increment + 1_500_000_000_000)
								}
							}),
						showLine: true,
						borderColor: '#28568a',
					...
					},
					{
						...
						data: Array(14)
							...
							.map((i, index) => {
								...
								return {
									x: increment + 1_500_000_000_000,
									y: lineRegFuncRatingMal(increment + 1_500_000_000_000)
								}
							}),
						showLine: true,
						borderColor: '#f0d732',
